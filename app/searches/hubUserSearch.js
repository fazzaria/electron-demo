...
module.exports = function(req,res) {
	...
	var configNames = [];
	configNames.push(req.query.projectID.slice(-3) == "PRD" ? "productionHub" : "demoHub")
	...
	function addResults(config) {
		sql.execute( config, {
			query: sql.fromFile("../sql/QuickSearchUsers"),
			params: params
				...
				console.log(err.message, " at quick user search");
